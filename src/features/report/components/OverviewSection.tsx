...
export function OverviewSection({
  ...
  const totalArticleWordCount = articleWorks.reduce(
  ...
  const avgWordCount =
    articleWorks.length > 0
      ? Math.round(totalArticleWordCount / articleWorks.length)
      : 0;

  // プロフェッショナルレベルの判定
  const getExpertiseLevel = () => {
    if (works.length >= 10 && totalArticleWordCount >= 50000)
      return "エキスパート";
    if (works.length >= 5 && totalArticleWordCount >= 20000)
      return "プロフェッショナル";
    ...
    <div className="space-y-4 sm:space-y-6">
      ...
      {profile?.skills && (
        <Card className="hover:shadow-md transition-shadow duration-200">
          ...
          <CardContent>
            <p className="text-gray-700 leading-relaxed">{profile.skills}</p>
          </CardContent>
        </Card>
      )}
      ...
      {profile?.career && (
        <Card className="hover:shadow-md transition-shadow duration-200">
            ...
            <CardTitle className="text-lg sm:text-xl flex items-center gap-2">
              ...
              >
                <path
                  ...
                  strokeLinejoin="round"
                  strokeWidth={2}
                  d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2-2v2m8 0H8m8 0v2a2 2 0 01-2 2H10a2 2 0 01-2-2V6m8 0H8m0 0H6a2 2 0 00-2 2v6a2 2 0 002 2h2m0 0h8a2 2 0 002-2v-6a2 2 0 00-2-2h-2m0 0V6a2 2 0 00-2-2H10a2 2 0 00-2 2v0"
                />
              </svg>
              <span>キャリア</span>
            </CardTitle>
          ...
          <CardContent>
            <p className="text-gray-700 leading-relaxed">{profile.career}</p>
          </CardContent>
        </Card>
      )}
      ...
      {/* サマリーカード */}
      <div
        className={`grid gap-4 ${hasInputs ? "grid-cols-2 lg:grid-cols-4" : "grid-cols-2"}`}
      >
        <Card className="hover:shadow-md transition-shadow duration-200">
          ...
          <CardContent className="p-4 sm:p-6">
            <div className="text-center">
              ...
              <div className="text-xs text-gray-500 mt-1">
                平均: {avgWordCount.toLocaleString()}文字
              </div>
            </div>
          </CardContent>
        </Card>
            ...
            <div className="space-y-3">
              ...
              <ul className="space-y-2 text-sm text-gray-700">
                <li className="flex items-start space-x-2">
                  ...
                  <span>
                    {works.length}件の実績と
                    {totalArticleWordCount.toLocaleString()}文字の執筆経験
                  </span>
                </li>
                <li className="flex items-start space-x-2">
                  <span className="text-blue-500 mt-1">•</span>
                ...
                <div className="space-y-2">
                  ...
                  {workStats.totalWordCount > 10000 && (
                    <div className="bg-blue-50 rounded-lg p-3 border-l-4 border-blue-400">
                      ...
                      <p className="text-xs text-blue-600">
                        総{workStats.totalWordCount.toLocaleString()}
                        文字の執筆実績
                      </p>
                    </div>
                  )}
                  ...
                  {workStats.roleDistribution.length >= 2 && (
                    <div className="bg-blue-50 rounded-lg p-3 border-l-4 border-blue-400">
                      ...
                      <p className="text-xs text-blue-600">
                        {workStats.roleDistribution.length}つの役割を経験
                      </p>
                    </div>
                  )}
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2">
                  {(() => {
                    ...
                    // 文字数に基づく提案
                    const avgWordCount =
                      works.filter((w) => w.content_type === "article").length >
                      0
                        ? workStats.totalWordCount /
                          works.filter((w) => w.content_type === "article")
                            .length
                        : 0;
