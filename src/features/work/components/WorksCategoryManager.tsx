  ...
  return (
    ...
    >
      <div>
        ...
        <div className="mb-6">
          {/* カテゴリタブ（グラスモーフィズム風） */}
          <div className="bg-gradient-to-r from-gray-50/80 to-slate-50/80 backdrop-blur-sm rounded-2xl p-2 mb-4 border border-gray-100/80">
            <div className="flex flex-wrap gap-2">
              {/* ALL ボタン - プレミアムデザイン */}
              <button
                onClick={() => setSelectedCategory("all")}
                className={`relative px-5 py-2.5 text-sm font-medium transition-all duration-300 rounded-xl ${selectedCategory === "all"
                  ? "bg-white text-blue-600 shadow-[0_4px_12px_rgba(59,130,246,0.15)] border border-blue-100/80 ring-1 ring-blue-50"
              ...
              >
                <span className="flex items-center gap-2.5">
                  ...
                  <span
                    className={`text-xs px-2 py-0.5 rounded-full transition-colors ${selectedCategory === "all"
              ...
              <button
                ...
                className="px-5 py-2.5 text-sm font-medium text-blue-600 hover:text-blue-700 rounded-xl transition-all duration-300 border-2 border-dashed border-blue-200 hover:border-blue-400 hover:bg-blue-50/50 hover:shadow-sm group"
                title="新しいカテゴリを追加"
              >
                <span className="flex items-center gap-2">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mt-5 pt-5 border-t border-gray-100">
            ...
            <div className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-gray-50 to-slate-50 rounded-xl border border-gray-100">
              <svg
              ...
              <span className="text-sm">
                <span className="font-semibold text-blue-600">{filteredWorks.length}</span>
                <span className="text-gray-500">件表示中</span>
              </span>
            </div>
          </div>
        </div>
