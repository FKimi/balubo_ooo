  ...
  return (
    <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-white/95 backdrop-blur-xl border-t border-gray-200/80 z-50 shadow-elegant-lg">
      <div className="flex justify-around py-2">
        <Link href="/feed" className="flex flex-col items-center py-3 px-4 text-gray-600 hover:text-[#5570F3] transition-all duration-200 group active:scale-95">
        ...
        <Link href="/profile" className="flex flex-col items-center py-3 px-4 text-gray-600 hover:text-[#5570F3] transition-all duration-200 group active:scale-95">
        ...
        <Link href="/works" className="flex flex-col items-center py-3 px-4 text-gray-600 hover:text-[#5570F3] transition-all duration-200 group active:scale-95">
          <svg className="w-5 h-5 mb-1 group-hover:scale-110 transition-transform duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
