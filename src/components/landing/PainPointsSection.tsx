...
export default function PainPointsSection() {
  ...
  const { ref: solutionsRef, isVisible: solutionsVisible } =
    useScrollAnimation(0.2);
      ...
      <div className="container mx-auto max-w-7xl relative">
        ...
        <div className="text-center">
          ...
          <p className="mx-auto max-w-3xl text-lg text-gray-600 leading-relaxed">
            ...
            <span className="font-semibold text-gray-900">専門性の可視化</span>
            と<span className="font-semibold text-gray-900">価値の伝達</span>
            の課題。
        ...
        <div ref={solutionsRef} className="text-center">
          <div
            className={`inline-flex items-center gap-3 mb-6 px-4 py-2 bg-slate-50 rounded-full border border-slate-200 transition-all duration-700 ease-out ${
              solutionsVisible
                ? "opacity-100 translate-y-0"
                : "opacity-0 translate-y-8"
            }`}
          ...
          <h2
            className={`text-4xl font-bold text-gray-900 md:text-5xl mb-6 transition-all duration-700 ease-out ${
              solutionsVisible
                ? "opacity-100 translate-y-0"
                : "opacity-0 translate-y-8"
            }`}
          ...
          <p
            className={`mx-auto max-w-3xl text-lg text-gray-600 leading-relaxed transition-all duration-700 ease-out ${
              solutionsVisible
                ? "opacity-100 translate-y-0"
                : "opacity-0 translate-y-8"
            }`}
          ...
          >
            あなたの専門性を、誰にでも伝わる「
            <span className="font-semibold text-gray-900">証明書</span>
            」へと変換します。
            <br className="hidden sm:block" />
