...
const voices: Voice[] = [
  {
    name: '田中 美咲',
    role: 'BtoBコンテンツマーケター',
    comment: 'これまで感覚的に伝えていた自分の強みが、「SaaS業界への解像度」といった客観的なデータで可視化されて驚きました。クライアントへの提案でも説得力が格段に上がり、専門家として認識され、単価アップにも繋がっています。',
    avatarInitial: '田',
  },
  {
    name: '佐藤 健太',
    role: 'DXコンサルタント',
    comment: 'AIによる制作物分析で、自分では気づかなかった得意分野が明らかになりました。今では特化した領域での案件依頼が増え、より充実した仕事ができています。',
    avatarInitial: '佐',
  },
  {
    name: '山田 雅子',
