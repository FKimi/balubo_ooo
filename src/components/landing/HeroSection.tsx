            ...
            <div className="space-y-8 text-center lg:text-left">
              <h1 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl md:text-5xl lg:text-6xl">
                <span className="block leading-tight">
                  その専門性、
                  <span className="ml-2 text-indigo-600">証明できますか？</span>
                </span>
              </h1>

              <div className="mx-auto max-w-2xl space-y-6 text-base text-gray-600 sm:text-lg lg:mx-0">
                <p>
                  <span className="font-semibold text-gray-900">balubo</span>
                  は、BtoB領域で活躍するプロクリエイターのためのAIポートフォリオプラットフォームです。
                </p>
                <p>
                  あなたの制作実績を登録するだけで、AIがその背景にある「
                  ...
                  」を分析・可視化。これまで言語化が難しかったあなたの本当の価値を、客観的なデータとして証明します。
                </p>
                <p>
                  専門性を正しく伝え、その価値を理解するクライアントと出会う。
                  <span className="font-semibold text-gray-900">balubo</span>
                  は、プロクリエイターと発注者のミスマッチを解消し、日本のビジネスをさらに前進させます。
                </p>
              </div>
