  ...
  },
  {
    icon: (
      <svg
        ...
        className="h-7 w-7 text-white"
      >
        <path d="M16 3a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h8z" />
        <path d="M12 7h.01" />
        <path d="M12 11h.01" />
        <path d="M12 15h.01" />
      </svg>
  ...
  return (
    <section id="features" className="bg-white py-20 px-4 md:py-28">
      <div className="container mx-auto max-w-5xl">
        ...
        <div
          ref={ref}
          className="mt-16 grid gap-8 md:mt-20 sm:grid-cols-2 lg:grid-cols-3"
        >
          {highlights.map((item, idx) => (
            ...
            >
              <div className="relative z-10">
                <div
                  className={`mb-6 flex h-16 w-16 items-center justify-center rounded-lg bg-indigo-600 text-white transition-all duration-500 ${
                    visibleItems.includes(idx)
                      ? "scale-100 rotate-0"
                      : "scale-75 rotate-12"
                  }`}
                ...
                <h3
                  className={`mb-3 text-xl font-semibold text-gray-900 transition-all duration-500 ${
                    visibleItems.includes(idx)
