  ...
  return (
    <div className="w-full flex justify-center">
      <div className="max-w-md flex flex-col items-center text-center py-12">
        <h4 className="text-lg md:text-xl font-semibold text-gray-600 mb-2">{title}</h4>
        {message && <p className="text-gray-500 mb-4 whitespace-pre-line">{message}</p>}
        {ctaLabel && (ctaHref ? (
          ...
          <Button onClick={onCtaClick} className="bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-700 hover:to-blue-600 text-white rounded-2xl shadow-lg shadow-blue-400/30 transition-all duration-300 mx-auto">
            {ctaLabel}
          </Button>
        ))}
        {children}
