      ...
      <div className="w-full max-w-md">
        ...
        <Card className="backdrop-blur-sm bg-white/90 shadow-xl border-0 relative z-10 rounded-3xl">
          <CardHeader className="text-center pb-6 pt-8">
            <CardTitle className="text-2xl font-bold text-gray-900 mb-2">新規登録</CardTitle>
          ...
          <CardContent className="px-8 pb-10">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3 p-5 rounded-2xl border-2 border-blue-100/50 bg-blue-50/30 hover:border-blue-200/60 hover:bg-blue-50/50 transition-all duration-300">
                  ...
                  <Label htmlFor="agreeToTerms" className="text-sm text-gray-600 leading-relaxed cursor-pointer">
                    ...
                    および
                    <Link href="/privacy" className="text-blue-600 hover:text-blue-700 hover:underline font-medium transition-colors duration-200">
                      プライバシーポリシー
                    </Link>
                    に同意します
                  </Label>
              ...
              <Button 
                type="submit"
                className="w-full h-14 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-semibold rounded-2xl transition-all duration-300 transform hover:scale-[1.02] hover:shadow-xl hover:shadow-blue-300/30"
                disabled={isLoading}
              >
            ...
            <div className="mt-8 text-center">
              <p className="text-sm text-gray-600">
                すでにアカウントをお持ちですか？{' '}
                <Link href="/login" className="text-blue-600 hover:text-blue-700 hover:underline font-semibold transition-colors duration-200">
                  ログイン
                </Link>
              </p>
            </div>
