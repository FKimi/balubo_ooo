...
export async function GET(_request: NextRequest) {
  try {
    ...
    if (columnsError) {
      ...
      if (schemaError) {
        ...
        return NextResponse.json({
          ...
          has_production_notes: sampleData
            ? "production_notes" in sampleData
            : false,
        });
      }
      ...
      return NextResponse.json({
        ...
        has_production_notes:
          schemaData?.some((col) => col.column_name === "production_notes") ||
          false,
      });
    }
    ...
    return NextResponse.json({
      ...
      columns: columns,
      has_production_notes:
        columns?.some((col: any) => col.column_name === "production_notes") ||
        false,
    });
  } catch (error) {
