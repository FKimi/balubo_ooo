  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-4xl mx-auto px-4">
        <h1 className="text-3xl font-bold text-gray-900 mb-8">OGP画像プレビュー</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-lg shadow-lg p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="text-sm text-gray-600">
                <p><strong>URL:</strong> /api/og</p>
                <p><strong>パラメータ:</strong> title, description, type, author</p>
                <p><strong>サイズ:</strong> 1200x630px</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-lg p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="text-sm text-gray-600">
                <p><strong>URL:</strong> /api/og/analysis/[workId]</p>
                <p><strong>データ:</strong> データベースから動的取得</p>
                <p><strong>サイズ:</strong> 1200x630px</p>
              </div>
            </div>
          </div>
              ...
              <div className="border border-gray-200 rounded-lg p-4 bg-gray-50">
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-sm text-gray-600">クリエイターのためのポートフォリオプラットフォーム</div>
                  </div>
                </div>
                <div className="mt-3">
        ...
        <div className="mt-12 bg-white rounded-lg shadow-lg p-6">
          ...
          <div className="space-y-4 text-sm">
            <div>
              ...
              <p className="text-gray-600">デフォルトのOGP画像として使用されます。</p>
            </div>
            <div>
              <h3 className="font-semibold text-gray-900">2. 動的OGP画像</h3>
              <p className="text-gray-600">クエリパラメータでカスタマイズ可能です。</p>
              <code className="block bg-gray-100 p-2 rounded mt-2">
                /api/og?title=タイトル&description=説明&type=work&author=作者
              </code>
            </div>
            <div>
              <h3 className="font-semibold text-gray-900">3. 作品詳細OGP画像</h3>
              <p className="text-gray-600">作品IDに基づいて自動生成されます。</p>
              <code className="block bg-gray-100 p-2 rounded mt-2">
