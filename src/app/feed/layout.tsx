...
const FEED_METADATA = {
  title: 'フィード - balubo',
  description: 'クリエイターたちの作品とインプットを発見しよう。新しいアイデアやインスピレーションを見つけられます。',
  url: 'https://www.balubo.jp/feed',
  imageUrl: 'https://www.balubo.jp/api/og?title=フィード&description=クリエイターたちの作品とインプットを発見しよう&type=default',
} as const
