        ...
        return (
          <div className="space-y-8">
            ...
            <div className="bg-[#5570F3]/5 rounded-2xl p-6 border border-[#5570F3]/20">
              <h3 className="text-xl font-semibold mb-3 text-[#5570F3]">
                はじめるには
              </h3>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex flex-wrap gap-2">
                        <Badge
                          variant="outline"
                          className="border-[#5570F3] text-[#5570F3]"
                        >
                          推奨サイズ: 400×400px
                        </Badge>
                        <Badge
                ...
                <CardContent className="p-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex flex-wrap gap-2">
                        <Badge className="bg-[#5570F3]/10 text-[#5570F3] border-[#5570F3]/20">
                          Photoshop
                        </Badge>
                        <Badge className="bg-[#5570F3]/10 text-[#5570F3] border-[#5570F3]/20">
                          Illustrator
        ...
        return (
          <div className="space-y-8">
            <div>
              ...
              <p className="text-lg text-gray-700 leading-relaxed mb-6">
                URLを入力するだけで AI
                が自動で作品情報を生成！効率的に魅力的なポートフォリオを作成できます。
              </p>
            </div>
                    ...
                    <div className="flex-1">
                      ...
                      <div className="space-y-3">
                        <div className="flex items-start gap-3">
                          <div className="w-6 h-6 bg-[#5570F3] text-white rounded-full flex items-center justify-center text-xs font-bold flex-shrink-0">
                            1
                          </div>
                          <div>
                            <span className="font-medium">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="bg-[#5570F3]/5 p-4 rounded-lg border border-[#5570F3]/20">
                        <p className="text-sm text-gray-700">
                          💡 <strong>コツ:</strong>{" "}
                          多様なスキルをアピールできるよう、異なるタイプの作品を主な作品に設定するのがおすすめです。
                        </p>
                      </div>
                    </div>
                  </div>
            ...
            <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">
                          異なるタイプの作品を複数投稿することで、より詳細な分析が可能になります
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">
                          制作意図や工夫した点を詳しく書くことで、AIがより深く理解できます
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
              ...
              <Card className="border-[#5570F3]/20">
                <CardContent className="p-6">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      <h4 className="font-medium text-[#5570F3] mb-3">
                        キャリア開発
                      </h4>
                      <ul className="space-y-2 text-sm text-gray-600">
                        <li>• 強みを活かせる職種の発見</li>
            ...
            <div className="space-y-4">
              {[
                ...
                },
                {
                  ...
                  answer:
                    "作品投稿数に制限はありません。お気軽にたくさんの作品を投稿してください。ただし、一つの作品のファイルサイズは10MBまでとなっています。",
                },
                {
                  question: "他の人の作品をダウンロードできますか？",
                  answer:
                    "作品の著作権は投稿者に帰属します。他の人の作品を無断で使用することはできません。利用したい場合は、必ず投稿者に直接お問い合わせください。",
                },
                {
                  question: "AI分析はどの程度正確ですか？",
                  answer:
                    "AI分析は投稿された作品データに基づいて行われます。より多くの作品を投稿し、詳細な情報を記載することで分析精度が向上します。参考情報としてご活用ください。",
                },
                {
                  question: "アカウントを削除したい場合は？",
                  answer:
                    "プロフィール設定ページからアカウント削除を行えます。削除すると、投稿した作品やプロフィール情報はすべて削除され、復元できませんのでご注意ください。",
                },
                {
                  question: "商用利用は可能ですか？",
                  answer:
                    "はい、baluboで作成したポートフォリオを商用目的でご利用いただけます。営業資料や提案書への掲載、クライアントへの共有なども可能です。",
                },
                {
                  question: "技術的な問題が発生した場合は？",
                  answer:
                    "お使いのブラウザを最新版に更新し、キャッシュをクリアしてから再度お試しください。問題が解決しない場合は、お問い合わせフォームからご連絡ください。",
                },
              ].map((item, index) => (
                <Card key={index} className="border-[#5570F3]/20">
                  <CardContent className="p-6">
                    <h3 className="text-lg font-semibold mb-3 text-[#5570F3]">
                      Q. {item.question}
                    </h3>
            ...
            <Card className="border-[#5570F3]/20 bg-[#5570F3]/5">
              <CardContent className="p-6 text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-3 justify-center">
                  ...
                  <Button
                    variant="outline"
                    className="border-[#5570F3] text-[#5570F3] hover:bg-[#5570F3]/10"
                  >
                    <ExternalLink className="w-4 h-4 mr-2" />
                    運営会社サイト
                  </Button>
